...
CREATE TABLE IF NOT EXISTS `usuarios` (
  ...
  `assinaturaImg` longtext DEFAULT NULL,
...
(15, 'control_2vias', '0'),
(16, 'usar_assinatura', '1'), 
(17, 'status_assinatura', 'Aprovado');
...
INSERT IGNORE INTO `usuarios` (`idUsuarios`, `nome`, `rg`, `cpf`, `cep`, `rua`, `numero`, `bairro`, `cidade`, `estado`, `email`, `senha`, `telefone`, `celular`, `situacao`, `dataCadastro`, `permissoes_id`, `dataExpiracao`, `assinaturaImg`) VALUES
