...
CREATE TABLE IF NOT EXISTS `usuarios` (
  ...
  `assinaturaImg` LONGTEXT  NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `os` (
  ...
  `assClienteImg` LONGTEXT,
  `assClienteIp` VARCHAR(20),
  `assClienteData` DATETIME,
  `assTecnicoImg` LONGTEXT,
  `assTecnicoIp` VARCHAR(20),
  `assTecnicoData` DATETIME,
  PRIMARY KEY (`idOs`),
