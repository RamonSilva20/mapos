...
class CI_Email {
	...
	var	$mailpath		= "/usr/lib/sendmail";	// Sendmail path PROD
	var	$protocol		= "sendmail";	// mail/sendmail/smtp PROD
	var	$smtp_host		= "ssl://smtp.gmail.com";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "computadorpontocom@gmail.com";		// SMTP Username
	...
	var	$_protocols		= array('smtp', 'mail', 'sendmail');
