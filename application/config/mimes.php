...
return [
    ...
    'pem' => ['application/x-x509-user-cert', 'application/x-pem-file', 'application/octet-stream', 'text/plain'],
    'p10' => ['application/x-pkcs10', 'application/pkcs10'],
    'p12' => ['application/x-pkcs12', 'application/pkcs12', 'application/octet-stream'],
    'pfx' => ['application/x-pkcs12', 'application/pkcs12', 'application/octet-stream'],
