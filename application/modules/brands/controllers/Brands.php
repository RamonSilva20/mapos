...
class Brands extends MX_Controller
{
    ...
    {
        // set breadcrumb
        set_breadcrumb($this->lang->line('brands'),site_url('brands'));
    ...
    public function read($id) 
    {
        ...
        // set breadcrumb
        set_breadcrumb($this->lang->line('brands'),site_url('brands'), $this->lang->line('app_view'), site_url('brands/read/'.$id));
    ...
    public function create() 
    {
        ...
        // set breadcrumb
        set_breadcrumb($this->lang->line('brands'),site_url('brands'), $this->lang->line('app_create'), site_url('brands/create'));
        $data = array(
    ...
    public function update($id) 
    {
        ...
        // set breadcrumb
        set_breadcrumb($this->lang->line('brands'),site_url('brands'), $this->lang->line('app_edit'), site_url('brands/update/'.$id));
    ...
    public function update_action() 
    {
        ...
        // set breadcrumb
        set_breadcrumb($this->lang->line('brands'),site_url('brands'), $this->lang->line('app_edit'), site_url('brands/update'));
