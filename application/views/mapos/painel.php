<link  href="<?= base_url(); ?>assets/js/dist/jquery.jqplot.min.css" rel="stylesheet" type="text/css"/>

<script src="<?= base_url(); ?>assets/js/dist/jquery.jqplot.min.js" type="text/javascript"></script>
<script src="<?= base_url(); ?>assets/js/dist/plugins/jqplot.pieRenderer.min.js" type="text/javascript"></script>
<script src="<?= base_url(); ?>assets/js/dist/plugins/jqplot.donutRenderer.min.js" type="text/javascript"></script>
            ...
            <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'vGarantia')): ?>
                <li class="bg_ls">
                    <a href="<?= base_url(); ?>index.php/garantias"><i class="fas fa-book" style="font-size:36px"></i>
                        <div>Termo de Garantia <span class="badge badge-light">F7</span></div>
                    </a>
                </li>
            <?php endif; ?>
        </ul>
            ...
            <div class="widget-content nopadding">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <?php else: ?>
                            <tr>
                                <td colspan="6" style="text-align: center">Nenhum produto com estoque baixo.</td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
            ...
            <div class="widget-content nopadding">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <?php if ($ordens != null): ?>
                            <?php foreach ($ordens as $o): ?>
                                <tr>
                                    ...
                                    <td><?php
                                        if ($o->dataFinal != null): echo date('d/m/Y', strtotime($o->dataFinal));
                                        else:
                                            echo "";
                                        endif;
                                        ?>
                                    ...
                                    <td>
                                        <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'vOs')): ?>
                                            <a href="<?= base_url(); ?>index.php/os/visualizar/<?= $o->idOs ?>" class="btn"><i class="fas fa-eye"></i></a>
                                        <?php endif; ?>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        <?php else: ?>
                            <tr>
                                <td colspan="5" style="text-align: center">Nenhuma ordem de serviço em aberto.</td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
        ...
        <div class="widget-content nopadding">
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <?php else: ?>
                        <tr>
                            <td colspan="5" style="text-align: center">Nenhuma ordem de serviço aguardando peças.</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
...
<?php if ($estatisticas_financeiro != null): ?>
    <?php if ($estatisticas_financeiro->total_receita != null || $estatisticas_financeiro->total_despesa != null || $estatisticas_financeiro->total_receita_pendente != null || $estatisticas_financeiro->total_despesa_pendente != null): ?>
                    ...
                    <div class="span12">
                        <ul class="site-stats">
                            <li class="bg_lh"><i class="fas fa-users"></i>
                                <strong><?= $this->db->count_all('clientes'); ?></strong><small>Clientes</small>
                            </li>
                            <li class="bg_lh"><i class="fas fa-shopping-bag"></i>
                                <strong><?= $this->db->count_all('produtos'); ?></strong><small>Produtos </small>
                            </li>
                            <li class="bg_lh"><i class="fas fa-diagnoses"></i>
                                <strong><?= $this->db->count_all('os'); ?></strong><small>Ordens de Serviço</small>
                            </li>
                            <li class="bg_lh"><i class="fas fa-wrench"></i>
                                <strong><?= $this->db->count_all('servicos'); ?></strong><small>Serviços</small>
                            </li>
                        </ul>
                    </div>
                </div>
...
<?php
if (isset($estatisticas_financeiro) && $estatisticas_financeiro != null && $this->permission->checkPermission($this->session->userdata('permissao'), 'rFinanceiro')) {
