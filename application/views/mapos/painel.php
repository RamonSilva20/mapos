                ...
                $(function() {
                    var myChart = Highcharts.chart('chart-vendas-mes1', {
                        ...
                        series: [{
                                ...
                                data: [
                                    [<?php echo ($vendas_mes->VALOR_JAN_REC - $vendas_mes->VALOR_JAN_DES); ?>],
                            ...
                            },
                            {
                                ...
                                data: [
                                    [<?php echo ($vendas_mes->VALOR_JAN_REC); ?>],
                            ...
                            },
                            {
                                ...
                                data: [
                                    [<?php echo ($vendas_mes->VALOR_JAN_DES); ?>],
                            ...
                            },
                            {
                                ...
                                data: [
                                    [<?php echo ($vendas_mesinadipl->VALOR_JAN_REC); ?>],
