                ...
                <table class="table table-bordered">
                    <tbody>
                        <tr>
                            ...
                            <td> <span style="font-size: 20px; "> <?=$dados[0]->nome?> </span> </br>
                              <span><?=$dados[0]->cnpj?> </br>
                                 <?=$dados[0]->rua.', nº:'.$dados[0]->numero.', '.$dados[0]->bairro.' - '.$dados[0]->cidade.' - '.$dados[0]->uf?> </span> </br> <span> E-mail: <?=$dados[0]->email.' - Fone: '.$dados[0]->telefone?></span></td>
                        </tr>
                    </tbody>
                </table>
