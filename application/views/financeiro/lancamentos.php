...
<div class="new122" style="margin-top: 0; min-height: 100vh">
    ...
    <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'aLancamento')) { ?>
        <div class="span5" style="display:flex">
            <a href="#modalReceita" data-toggle="modal" role="button" class="button btn btn-mini btn-warning" style="width: 230px">
  ...
  <div class="modal-body">
    ...
    <?php $number = 0.00; ?>
		...
		<div class="span2"> 
          ...
          <input class="span12 money" id="valor" type="text" name="valor" value="<?php echo number_format($number ,2,",","") ?>" />
        </div>
