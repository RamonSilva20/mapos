                                ...
                                <tbody>
                                    <?php foreach ($clientes as $c) : ?>
                                        ...
                                        <tr>
                                            ...
                                            <td align="center"><?php echo $c->documento; ?></td>
                                            <td align="center"><?php echo $c->telefone; ?></td>
                                            <td align="center"><?php echo $c->email; ?></td>
                                            <td align="center"><?php echo $dataCadastro; ?></td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
                            </table>
