                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr style="background-color: gainsboro;">
                                        <td colspan="4"></td>
                                        <td align="center"><?php echo array_sum(array_column($produtos, 'estoque')); ?></td>
                                        <td align="center">R$: <?php echo number_format(array_sum(array_column($produtos, 'valorEstoque')), 2, ',', '.'); ?></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
