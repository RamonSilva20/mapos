                            ...
                            ?>
                                            <div class="detalheProdutoEtiqueta">
                                                <div class="descricaoProdutoEtiqueta">
                                                    ...
                                                    <div>
                                                        <strong>
                                                            <?php echo limitarTexto($string, $limite = 23); ?>
                                                        </strong>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="barcodecell">
                                                    <barcode code="<?php echo $p->codDeBarra; ?>" text="0" type="<?php echo $this->input->get('etiquetaCode'); ?>" size="0.7" disableborder="0" class="barcode" />
                                                </div>
                                            </div>
                                        <?php
                                        }
                                    ...
                                    foreach ($produtos as $p) {
                                        ...
                                        ?>
                                            <div class="detalheProdutoEtiquetaEan13">
                                                ...
                                                <div class="barcodecell">
                                                    <barcode code="<?php echo $p->codDeBarra; ?>" text="0" type="<?php echo $this->input->get('etiquetaCode'); ?>" size="0.62" disableborder="0" class="barcode" />
                                                </div>
                                            </div>
                                        <?php
                                        }
