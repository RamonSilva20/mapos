                            ...
                            <table width="100%" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr style="background-color: gainsboro;">
                                        <td colspan="5"></td>
                                        <td align="center"><small>R$: <?php echo number_format($total_produtos, 2, ',', '.'); ?></small></td>
                                        <td align="center"><small>R$: <?php echo number_format($total_servicos, 2, ',', '.'); ?></small></td>
                                        <td align="center"><small>R$: <?php echo number_format($total_produtos + $total_servicos, 2, ',', '.'); ?> </small></td>
                                        <td align="center"><small> </small></td>
                                        <td align="center"><small>R$: <?php echo number_format($total_geral, 2, ',', '.'); ?></small></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
