            ...
            <table class="table table-condensed">
                    ...
                    <table class="table table-condensed">
                        <tr>
                            <td colspan="5">
                                <h5>
                                    <div class="test2">
                                        <i class="fas fa-mobile-alt"></i> APARELHO/SERVIÇO
                                </h5>
                        ...
                        <table class="table table-condensed">
                            <tr>
                                <td colspan="5">
                                    <h5>
                                        <div class="test2">
                                            <i class="far fa-handshake"></i> CONDIÇÕES DE EXECUÇÃO
                                    </h5>
                                    <span class="test3"><b>1) - ATENÇÃO,</b> a não retirada do aparelho no prazo de 30
                                        dias serão acrescidos 10% no valor;
                                        após 60 dias implicará na venda do mesmo para pagamentos de gastos.
                                        <b>(art. 06. Item 03 do código de defesa do consumidor).</b> <br><b>2) -
                                        </b>Garantia e entrega somente com a ordem de serviço (O.S).</span>
                                </td>
                            </tr>
                            <table class="table table-condensed">
                                <tr>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td style="width: 15%; padding-left: 0">
                                                <img style="margin:0px 0px; width: 310px; height: 170px"
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td> <span style="font-size: 11px;">
                                                            <p class="text-center">(Para pagamento via PIX escanei este
                                                                código QR)</p>
                                                        </span>
                                                    </td>
                                                </tr>
                ...
                <tr>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td> <span style="font-size: 11px;">
                                                    <p class="text-center">Ass. Carimbo da Assistência Técnica</p><br>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td> <span style="font-size: 12px;">
                                                    <p class="text-center"><b>VIA CLIENTE</b>
                                            </td>
                                        </tr>
                                    </div>
    </div>
