...
return array(
    ...
    'Erase' => 'Apagar',
    'Open' => 'Abrir',
    'Confirm_del' => 'Tem certeza que quer excluir este arquivo?',
    'All' => 'Todos',
    'Files' => 'Arquivos',
    'Images' => 'Imagens',
    ...
    'Confirm_Folder_del' => 'Tem certeza que você quer excluir a pasta e todo o seu conteúdo?',
    ...
    'View_list' => 'Lista',
    'View_columns_list' => 'Colunas',
    'View_boxes' => 'Visualizar',
    'Toolbar' => 'Ferramentas',
    'Actions' => 'Ações',
    ...
    'Upload_base' => 'Lista de Upload',
    'Upload_base_help' => "Arraste e solte arquivos ou clique no botão superior para Adicionar o(s) arquivo(s) e clique em Iniciar upload. Quando o upload estiver concluído, clique no botão 'Voltar à lista de arquivos'.",
    'Upload_add_files' => 'Adicionar Arquivo(s)',
    'Upload_start' => 'Iniciar upload',
    'Upload_error_messages' =>array(
        1 => 'Arquivo excede diretiva em upload_max_filesize no php.ini',
        2 => 'Arquivo excede diretiva MAX_FILE_SIZE especificada no form HTML',
        3 => 'Upload concluido parcialmente',
        4 => 'Nenhum Arquivo foi enviado',
        6 => 'Perdeu pasta temporaria',
        7 => 'Erro ao gravar arquivo em disco',
        8 => 'PHP Cancelou envio do arquivo',
        'post_max_size' => 'O upload file excede o post_max_size em php.ini',
        'max_file_size' => 'Arquivo muito grande',
        'min_file_size' => 'Arquivo muito pequeno',
        'accept_file_types' => 'Tipo de arquivo nao é permitido',
        'max_number_of_files' => 'Número maximo de arquivos excedido',
        'max_width' => 'Imagem muito grande',
        'min_width' => 'Imagem muito pequena',
        'max_height' => 'Imagem muito grande',
        'min_height' => 'Imagem muito pequena',
        'abort' => 'Envio Cancelado',
