...
<nav id="sidebar">
    <div id="newlog">
        ...
        <div class="title1">
            <?php echo $configuration['app_theme'] == 'white' ? '<img src="' . base_url() . 'assets/img/logo-mapos.png">' : '<img src="' . base_url() . 'assets/img/logo-mapos-branco.png">'; ?>
        </div>
    </div>
    ...
    <!-- Start Pesquisar-->
    <li class="search-box">
        <form style="display: flex" action="<?php echo site_url('mapos/pesquisar'); ?>">
    ...
    <div class="menu-bar">
        <div class="menu">
            ...
            <ul class="menu-links" style="position: relative;">
                <li class="<?php if (isset($menuPainel)) {
                    ...
                    <a class="tip-bottom" title="" href="<?php echo base_url(); ?>"><i class='bx bx-home-alt iconX'></i>
                ...
                <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'vCliente')) { ?>
                    <li class="<?php if (isset($menuClientes)) {
                        ...
                        <a class="tip-bottom" title="" href="<?php echo site_url('clientes'); ?>"><i class='bx bx-group iconX'></i>
                ...
                <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'vProduto')) { ?>
                    <li class="<?php if (isset($menuProdutos)) {
                        ...
                        <a class="tip-bottom" title="" href="<?php echo site_url('produtos'); ?>"><i class='bx bx-package iconX'></i>
                ...
                <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'vServico')) { ?>
                    <li class="<?php if (isset($menuServicos)) {
                        ...
                        <a class="tip-bottom" title="" href="<?php echo site_url('servicos'); ?>"><i class='bx bx-stopwatch iconX'></i>
                ...
                <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'vVenda')) { ?>
                    <li class="<?php if (isset($menuVendas)) {
                        ...
                        <a class="tip-bottom" title="" href="<?php echo site_url('vendas'); ?>"><i class='bx bx-cart-alt iconX'></i></span>
                ...
                <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'vOs')) { ?>
                    <li class="<?php if (isset($menuOs)) {
                        ...
                        <a class="tip-bottom" title="" href="<?php echo site_url('os'); ?>"><i class='bx bx-spreadsheet iconX'></i>
                ...
                <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'vGarantia')) { ?>
                    <li class="<?php if (isset($menuGarantia)) {
                        ...
                        <a class="tip-bottom" title="" href="<?php echo site_url('garantias'); ?>"><i class='bx bx-receipt iconX'></i>
                ...
                <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'vArquivo')) { ?>
                    <li class="<?php if (isset($menuArquivos)) {
                        ...
                        <a class="tip-bottom" title="" href="<?php echo site_url('arquivos'); ?>"><i class='bx bx-box iconX'></i>
                ...
                <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'vLancamento')) { ?>
                    <li class="<?php if (isset($menuLancamentos)) {
                        ...
                        <a class="tip-bottom" title="" href="<?php echo site_url('financeiro/lancamentos'); ?>"><i class="bx bx-bar-chart-square iconX"></i>
                ...
                <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'vLancamento')) { ?>
                    <li class="<?php if (isset($menuCobrancas)) {
                        ...
                        <a class="tip-bottom" title="" href="<?php echo site_url('cobrancas/cobrancas'); ?>"><i class='bx bx-credit-card-front iconX'></i>
        ...
        <div class="botton-content">
            <li class="">
                <a class="tip-bottom" title="" href="<?php echo site_url('login/sair'); ?>">
