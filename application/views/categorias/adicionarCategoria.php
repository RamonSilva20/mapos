                ...
                <div class="widget-content nopadding tab-content">
                    <div class="span6">
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input id="categoria" type="text" name="categoria" value="<?php echo set_value('categoria'); ?>" placeholder="Ex: Vendas, Compras, Salários..." />
                            </div>
                        </div>
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <select id="tipo" name="tipo">
                                    ...
                                    <option value="receita" <?= set_value('tipo') == 'receita' ? 'selected' : '' ?>>Receita</option>
                                    <option value="despesa" <?= set_value('tipo') == 'despesa' ? 'selected' : '' ?>>Despesa</option>
                                </select>
                            </div>
                        </div>
                    </div>
