...
<div id="modal-faturar" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <form id="formFaturar" action="<?php echo current_url() ?>" method="post">
        ...
        <span class="alert alert-danger" role="alert" style="display: block; margin: 3%;">
  <h4 class="alert-heading">Alerta!</h4>
  <p>Informe ao cliente .</p>
  <hr>
  <p class="mb-0">Sobre as variações no valor das rações.</p>
</span>
        <div class="modal-body">
            ...
            <div class="span12" style="margin-left: 0">
                ...
                <div class="span4">
                    ...
                    <input style="width: 4em;" id="num2" type="text" name="desconto"  placeholder="%" onblur="calcular()" maxlength="3" size="2" />
                </div>
            </div>
            <div class="span12" style="margin-left: 0">
                <div class="span4" style="margin-left: 0">
                  ...
                  <!--   <input id="valorComDesconto" type="text" name="valorComDesconto" value="10" /> -->
                </div>
            </div>
            <div class="span12" style="margin-left: 0">
                <div class="span4" style="margin-left: 0">
