                ...
                <?php
                    ...
                    foreach ($results as $r) {
                        ...
                        if ($this->permission->checkPermission($this->session->userdata('permissao'), 'vCobranca')) {
                            echo '<a style="margin-right: 1%" href="' . base_url() . 'mine/atualizarcobranca/' . $r->idCobranca . '"  class="btn-nwe" title="Atualizar Cobrança"><i class="bx bx-refresh"></i></a>';
                        }
                        ...
                        if ($this->permission->checkPermission($this->session->userdata('permissao'), 'eCobranca')) {
                            ...
                            echo '<a style="margin-right: 1%" href="' . base_url() . 'mine/enviarcobranca/' . $r->idCobranca . '" class="btn-nwe2" title="Reenviar por email"><i class="bx bx-mail-send" ></i></a>';
                        }
                        echo '</td>';
                        echo '</tr>';
                    } ?>
