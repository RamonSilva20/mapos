...
<html lang="pt-br">
    <head>
        ...
        <link href="<?php echo base_url('assets/css/particula.css'); ?>" rel="stylesheet">
                            ...
                            <div class="container">
                                <div class="card card-cad">
                                    <div class="content">
                                        ...
                                        <div id="mcell">Versão: <?php echo $this->config->item('app_version'); ?></div>
                                        ...
                                        <a href="<?php echo site_url('mine/cadastrar'); ?>" class="btn btn-success btn-large">Cadastrar-me</a>
                                        <div class="links-uteis"><a href="<?php echo site_url('mine/resetarSenha'); ?>">
                                                <p style="margin:0px 0 18px">Esqueceu a senha?</p>
                                            </a></div>
                                        <div class="links-uteis"><a href="https://github.com/RamonSilva20/mapos">
                                                <p><?php echo date('Y'); ?> &copy; Ramon Silva</p>
                                            </a></div>
                                    </div>
                                </div>
                            </div>
