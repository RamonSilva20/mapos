                ...
                <div class="widget-content nopadding tab-content">
                    <div class="span6">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input id="email" type="email" name="email" value="<?php echo ($result->email && strpos($result->email, '@exemplo.com') === false) ? $result->email : ''; ?>" autocomplete="off" placeholder="Digite o email do cliente" />
                            </div>
                        </div>
                        <div class="control-group">
