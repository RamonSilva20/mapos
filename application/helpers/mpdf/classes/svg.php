                ...
                // mPDF 5.7.4
                    case 'tspan':
                        ...
                        if (isset($attribs['x']) || isset($attribs['y'])) {
                            ...
                            } elseif ($svg_class->textanchor == 'middle') {
                ...
                for ($sch=0; $sch<=$subchunk; $sch++) {
                    if (isset($chardata[$sch])) {
                     ...
                     // Check Vietnamese if Latin script - even if Basescript
                        ...
                        elseif ($scriptblocks[$sch] == UCDN::SCRIPT_ARABIC && $this->mpdf_ref->autoArabic) {
                            if (preg_match("/[".$this->sindhi ."]/u", $s)) {
                                ...
                                $lang="fa";
                            } elseif ($this->mpdf_ref->baseScript != UCDN::SCRIPT_ARABIC  && isset($this->script2lang[$scriptblocks[$sch]])) {
                                $lang="'.$this->script2lang[$scriptblocks[$sch]].'";
                            }
                        } // Identify Script block if not Basescript, and mark up as language
                        elseif ($scriptblocks[$sch] > 0 && $scriptblocks[$sch] != $this->mpdf_ref->baseScript && isset($this->script2lang[$scriptblocks[$sch]])) {
                            $lang=$this->script2lang[$scriptblocks[$sch]];
                        }
                        if ($lang) {
