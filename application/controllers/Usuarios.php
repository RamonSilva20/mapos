...
class Usuarios extends MY_Acesso
{
    ...
    public function adicionar()
    {
        ...
        if ($this->form_validation->run('usuarios') == false) {
            ...
            $data = array(
                    ...
                    'senha' => password_hash($this->input->post('senha'), PASSWORD_DEFAULT, ['COST' => 10]),
    ...
    public function editar()
    {
        ...
        $this->load->library('form_validation');
        $this->data['custom_error'] = '';
        if ($this->form_validation->run('usuariosEdita') == false) {
        ...
        // var_dump($this->usuarios_model->edit('usuarios', $data, 'idUsuarios', $this->input->post('idUsuarios')) == true);
        // exit;
