...
class Vendas extends MY_Controller
{
    ...
    public function imprimirRecibo()
    {
        ...
        $this->data['produtos'] = $this->vendas_model->getProdutos($this->uri->segment(3));
        $this->data['emitente'] = $this->mapos_model->getEmitente();
        $this->data['lancamentos'] = ($this->financeiro_model->get('lancamentos','valor,baixado,data_pagamento',"vendas_id=".$this->uri->segment(3),'1'));
        
        $this->load->view('vendas/imprimirVendaRecibo', $this->data);
    }
}
